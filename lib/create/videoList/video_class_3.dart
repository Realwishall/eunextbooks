...
VideoData BrainTrainClass3 = VideoData(
    heading: "Brain Train",
    info:
    ...
    className: "Brain Train, Class-3",
    videoID: []);

VideoData GrammarGiggleClass3 = VideoData(
    ...
    className: "Grammar Giggle, Class-3",
    videoID: []);

VideoData HindiPrabhatClass3 = VideoData(
    ...
    className: "HindiPrabhat, Class-3",
    videoID: []);

VideoData ScienceEraClass3 = VideoData(
    heading: "Science Era",
    info:
    ...
    className: "Science Era, Class-3",
    videoID: []);

VideoData MathsMasterClass3 = VideoData(
    ...
    className: "MathsMaster, Class-3",
    videoID: []);

VideoData SocialSafariClass3 = VideoData(
    heading: "Social Safari",
    info:
        "Curiosity and science are synonymous with each other. EuNext's Science Era series aims to develop curiosity about 'why things are, the way they are' among the young learners. The world looks up to Science for finding answers to discoveries and innovations for the betterment of lives.",
    className: "ScienceEra, Class-3",
    videoID: []);

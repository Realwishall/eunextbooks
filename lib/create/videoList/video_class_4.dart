...
VideoData BrainTrainClass4 = VideoData(
    heading: "Brain Train",
    info:
    ...
    className: "Brain Train, Class-4",
    videoID: []);

VideoData GrammarGiggleClass4 = VideoData(
    ...
    className: "Grammar Giggle, Class-4",
    videoID: []);

VideoData HindiPrabhatClass4 = VideoData(
    ...
    className: "HindiPrabhat, Class-4",
    videoID: []);

VideoData ScienceEraClass4 = VideoData(
    heading: "Science Era",
    info:
    ...
    className: "Science Era, Class-4",
    videoID: []);

VideoData MathsMasterClass4 = VideoData(
    ...
    className: "MathsMaster, Class-4",
    videoID: []);

VideoData SocialSafariClass4 = VideoData(
    heading: "Social Safari",
    info:
        "Curiosity and science are synonymous with each other. EuNext's Science Era series aims to develop curiosity about 'why things are, the way they are' among the young learners. The world looks up to Science for finding answers to discoveries and innovations for the betterment of lives.",
    className: "ScienceEra, Class-4",
    videoID: []);

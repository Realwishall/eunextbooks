...
VideoData BrainTrainClass2 = VideoData(
    heading: "Brain Train",
    info:
    ...
    className: "Brain Train, Class-2",
    videoID: []);

VideoData GrammarGiggleClass2 = VideoData(
    ...
    className: "Grammar Giggle, Class-2",
    videoID: []);

VideoData HindiPrabhatClass2 = VideoData(
    ...
    className: "HindiPrabhat, Class-2",
    videoID: []);

VideoData ScienceEraClass2 = VideoData(
    heading: "Science Era",
    info:
    ...
    className: "Science Era, Class-2",
    videoID: []);

VideoData MathsMasterClass2 = VideoData(
    ...
    className: "MathsMaster, Class-2",
    videoID: []);

VideoData SocialSafariClass2 = VideoData(
    heading: "Social Safari",
    info:
        "Curiosity and science are synonymous with each other. EuNext's Science Era series aims to develop curiosity about 'why things are, the way they are' among the young learners. The world looks up to Science for finding answers to discoveries and innovations for the betterment of lives.",
    className: "ScienceEra, Class-2",
    videoID: []);

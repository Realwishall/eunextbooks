...
VideoData BrainTrainClass8 = VideoData(
    heading: "Brain Train",
    info:
    ...
    className: "Brain Train, Class-8",
    videoID: []);

VideoData GrammarGiggleClass8 = VideoData(
    ...
    className: "Grammar Giggle, Class-8",
    videoID: []);

VideoData HindiPrabhatClass8 = VideoData(
    ...
    className: "HindiPrabhat, Class-8",
    videoID: []);

VideoData ScienceEraClass8 = VideoData(
    heading: "Science Era",
    info:
    ...
    className: "Science Era, Class-8",
    videoID: []);

VideoData MathsMasterClass8 = VideoData(
    ...
    className: "MathsMaster, Class-8",
    videoID: []);

VideoData SocialSafariClass8 = VideoData(
    heading: "Social Safari",
    info:
        "Curiosity and science are synonymous with each other. EuNext's Science Era series aims to develop curiosity about 'why things are, the way they are' among the young learners. The world looks up to Science for finding answers to discoveries and innovations for the betterment of lives.",
    className: "ScienceEra, Class-8",
    videoID: []);

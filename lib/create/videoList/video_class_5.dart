...
VideoData BrainTrainClass5 = VideoData(
    heading: "Brain Train",
    info:
    ...
    className: "Brain Train, Class-5",
    videoID: []);

VideoData GrammarGiggleClass5 = VideoData(
    ...
    className: "Grammar Giggle, Class-5",
    videoID: []);

VideoData HindiPrabhatClass5 = VideoData(
    ...
    className: "HindiPrabhat, Class-5",
    videoID: []);

VideoData ScienceEraClass5 = VideoData(
    heading: "Science Era",
    info:
    ...
    className: "Science Era, Class-5",
    videoID: []);

VideoData MathsMasterClass5 = VideoData(
    ...
    className: "MathsMaster, Class-5",
    videoID: []);

VideoData SocialSafariClass5 = VideoData(
    heading: "Social Safari",
    info:
        "Curiosity and science are synonymous with each other. EuNext's Science Era series aims to develop curiosity about 'why things are, the way they are' among the young learners. The world looks up to Science for finding answers to discoveries and innovations for the betterment of lives.",
    className: "ScienceEra, Class-5",
    videoID: []);
